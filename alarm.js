...
class alarm extends Component {
    ...
    onPressSendNotification = () =>{
        notification.finish('backgroundSendResultData')
    }
        ...
        <Fragment>
            ...
            <View style={styles.footer}> 
                <View style={styles.button}>
                    <Button  title="Okay, I will take" onPress={onPressSendNotification()} />
                    <Button title="Remind 5 min later" onPress={onPressCancelNotification()} />
                </View>
            </View> 
        </Fragment>
        );
